...
export function LevelCard({
  ...
  const content = (
    <motion.div
      ...
      className={cn(
        "depth-scene group relative flex min-h-67 flex-col overflow-hidden rounded-2xl border-2 border-[#24130c] bg-brand-950 p-3 text-white shadow-[5px_7px_0_rgba(84,37,15,0.55)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[8px_10px_0_rgba(84,37,15,0.6)] sm:aspect-4/5 sm:min-h-0 sm:rounded-[18px] sm:p-5",
