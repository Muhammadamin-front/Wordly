...
export function WordCard({
  ...
  return (
    <WordFlipCard
        ...
        <div className="flex h-full flex-col p-3 sm:p-5">
          <div className="flex min-w-0 items-start gap-3 pr-7 sm:pr-12">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className={cn("mt-1 text-xs font-bold sm:text-sm", accentText)}>
                {word.cefr_level}
              </p>
            </div>
          </div>
          ...
          {word.primary_example_en && (
            <p className="mt-auto line-clamp-3 border-l border-brand-400/30 pl-2 text-[10px] leading-snug text-ink-soft sm:border-l-2 sm:pl-3 sm:text-sm sm:leading-relaxed">
              {word.primary_example_en}
            </p>
          )}
        </div>
      ...
      back={
        <div className="flex h-full flex-col p-3 pb-12 sm:p-5 sm:pb-20">
          ...
          {word.primary_example_en && (
            <p className="mt-2 line-clamp-2 border-l border-accent-400/40 pl-2 text-[10px] leading-snug text-ink-soft sm:mt-5 sm:border-l-2 sm:pl-3 sm:text-sm sm:leading-relaxed">
              {word.primary_example_en}
            </p>
          )}
        </div>
