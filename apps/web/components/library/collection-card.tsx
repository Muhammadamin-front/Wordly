...
export function CollectionCard({
  ...
  return (
    <motion.div
      ...
      className="premium-card group relative flex h-full flex-col overflow-hidden rounded-[24px] border border-white/10 p-6 shadow-[0_20px_60px_rgba(8,12,20,0.14)]"
    >
      ...
      <div className="relative z-10 flex items-start justify-between gap-3">
        <div className="flex min-w-0 items-start gap-3">
          <span className="flex size-12 shrink-0 items-center justify-center rounded-2xl border border-white/12 bg-white/20 text-brand-600 shadow-[0_10px_25px_rgba(16,24,40,0.08)] backdrop-blur-2xl dark:text-white">
      ...
      <div className="relative z-10 mt-5 grid grid-cols-2 gap-3">
        <div className="rounded-2xl border border-line/70 bg-card/50 px-4 py-3 backdrop-blur-xl">
        ...
        <div className="rounded-2xl border border-brand-400/20 bg-linear-to-br from-brand-600/10 to-transparent px-4 py-3 backdrop-blur-xl">
