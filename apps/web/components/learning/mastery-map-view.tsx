...
export function MasteryMapView({
  ...
  return (
    <main className="mx-auto w-full max-w-7xl flex-1 px-4 pb-16 pt-6 sm:px-6 lg:pt-10">
...
function MasteryLoading({ label }: { label: string }) {
  return (
    <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-8 sm:px-6" aria-label={label}>
