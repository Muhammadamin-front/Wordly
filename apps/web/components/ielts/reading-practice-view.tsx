...
function ReadingWorkspace({ test, studyMode, answers, flagged, secondsLeft, paused, passageIndex, onAnswer, onToggleFlag, onPassageChange, onPause, onEnd, onExit }: {
  ...
  return (
    <main className="mx-auto w-full max-w-[1500px] flex-1 px-3 py-3 sm:px-5 sm:py-5" data-theme={theme}>
      <section className="overflow-hidden rounded-lg border border-line bg-page shadow-[0_20px_65px_rgba(27,64,55,0.12)]">
        <header className="sticky top-0 z-30 flex flex-wrap items-center justify-between gap-3 border-b border-line bg-raised/96 px-4 py-3 backdrop-blur sm:px-5">
        ...
        <nav className="sticky bottom-0 z-20 border-t border-line bg-raised/96 px-3 py-3 backdrop-blur sm:px-5" aria-label="Question navigation">
