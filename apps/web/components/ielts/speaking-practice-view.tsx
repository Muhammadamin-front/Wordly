...
import { QuestionWheel } from "@/components/ielts/question-wheel";
  ...
  return (
    <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-7 sm:px-6 sm:py-10">
      ...
      <QuestionWheel
        ...
        labels={{
          title: t.spinnerTitle,
          hint: t.spinnerHint,
          button: t.spinnerButton,
          again: t.spinnerAgain,
          spinning: t.spinnerSpinning,
          openTopic: t.spinnerOpenTopic,
          empty: t.spinnerEmpty,
          soundOn: t.spinnerSoundOn,
          soundOff: t.spinnerSoundOff,
        }}
      />
