          ...
          return (
            ...
            >
              <Link
                ...
                className={`group flex h-full flex-col rounded-xl2 border border-line bg-linear-to-br ${GAME_ACCENT[type]} to-transparent p-5 transition-all hover:-translate-y-1 hover:shadow-lg active:scale-[0.98]`}
              >
