  ...
  return (
    <main className="relative flex min-h-dvh flex-1 items-center justify-center overflow-hidden bg-auth-page p-0 lg:p-10">
      ...
      <div className="relative z-10 flex w-full max-w-295 justify-center px-6 py-12 sm:px-8 lg:block lg:px-0 lg:py-0">
        <div className="grid w-full max-w-102 overflow-hidden rounded-[18px] border-2 border-auth-line bg-auth-sheet shadow-auth-card lg:max-w-none lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:rounded-[22px]">
          ...
          <section className="flex min-w-0 flex-col px-6 py-8 sm:px-8 lg:px-14 lg:py-12 xl:px-20">
            ...
            <div className="mx-auto flex w-full min-w-0 max-w-108 flex-1 flex-col justify-center py-7 lg:py-10">
