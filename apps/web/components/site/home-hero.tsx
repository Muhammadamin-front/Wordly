...
export function HomeHero({
  ...
  return (
    <section
      ...
      className="home-field relative flex min-h-svh items-center justify-center px-4 py-7 sm:px-8 sm:py-12"
    >
      <div className="relative w-full max-w-370 overflow-hidden rounded-[22px] border-2 border-brand-950 bg-home-card shadow-home-card sm:rounded-[26px]">
        <div className="relative isolate">
          ...
          >
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              <LocaleSwitcher current={lang as Locale} tone="home" />
          ...
          <div className="relative z-10 grid gap-8 px-5 py-7 sm:px-8 sm:py-10 lg:grid-cols-[minmax(0,0.92fr)_minmax(21rem,0.75fr)] lg:items-center lg:gap-12 lg:px-12 lg:py-12">
            <div className="home-hero-copy min-w-0 lg:py-4">
              <TypingPillars items={copy.pillars} />
              <h1 id="home-hero-title" className="home-hero-title editorial-title mt-4 max-w-[12ch] text-balance text-[3.5rem] text-home-ink sm:text-[4.75rem] lg:max-w-[11ch] lg:text-[clamp(4.4rem,7.3vw,6.6rem)]">
                {copy.title}
              </h1>
              ...
              <div className="mt-7">
                <HeroCta
                  ...
                  variant="ghost"
                  className="min-h-12 gap-2.5 whitespace-nowrap rounded-md border-2 border-sand-100/30 bg-home-accent px-6 text-[0.82rem] font-black uppercase tracking-[0.06em] text-home-accent-contrast shadow-[5px_6px_0_rgba(0,0,0,0.38)] hover:-translate-y-0.5 hover:bg-home-accent-hover hover:shadow-[7px_8px_0_rgba(0,0,0,0.38)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[2px_3px_0_rgba(0,0,0,0.38)] max-[359px]:px-4"
              ...
              <ul className="mt-10 grid grid-cols-2 gap-2 sm:flex sm:flex-wrap">
                {copy.pillars.map((pillar, index) => {
                  ...
                  return (
                    <li
                      key={pillar}
                      className="home-hero-pillar flex items-center gap-2.5 border border-home-line px-3 py-2.5 text-left sm:min-w-[9rem]"
                      style={{ animationDelay: `${620 + index * 70}ms` }}
                    >
                      <Icon className="size-4 text-home-marker" aria-hidden strokeWidth={1.7} />
            ...
            <div className="relative mx-auto w-full max-w-[29rem]">
              <span aria-hidden className="home-hero-orbit absolute -left-4 top-[17%] hidden size-16 rounded-full border border-sand-100/28 bg-brand-500 lg:block" />
              <span aria-hidden className="home-hero-orbit home-hero-orbit-late absolute -right-3 bottom-[12%] h-20 w-20 border border-sand-100/22 bg-brand-500" />
              <div className="home-hero-poster relative aspect-[4/5] overflow-hidden rounded-[18px] border-2 border-sand-100/80 bg-brand-800 p-2 shadow-[10px_11px_0_rgba(0,0,0,0.42)]">
                <Image
        ...
        <div className="grid gap-5 border-t border-home-line bg-black/10 px-5 py-5 sm:px-8 lg:grid-cols-[auto_minmax(0,1fr)_auto] lg:items-center lg:gap-7">
          ...
          <div className="min-w-0">
            <p className="text-[0.8rem] font-black uppercase tracking-[0.08em] text-home-marker">
              {copy.shelfTitle}
            </p>
          ...
          <div className="flex items-center gap-3 rounded-lg border border-home-line px-4 py-3">
            <Sprout className="size-6 shrink-0 text-home-marker" aria-hidden strokeWidth={1.6} />
            <div>
