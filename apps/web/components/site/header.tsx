        ...
        <nav className="hidden items-center gap-6 text-sm font-medium text-ink-soft sm:flex">
          {ready && user ? (
            <>
              ...
              <Link href={`/${lang}/skills`} className="transition-colors hover:text-ink" title="Skills">
                📚
              </Link>
              <Link href={`/${lang}/ai`} className="transition-colors hover:text-ink" title="AI Tutor">
                ✨
              </Link>
              <Link href={`/${lang}/coach`} className="transition-colors hover:text-ink" title="Speaking Coach">
                🎙️
              </Link>
              ...
              <Link href={`/${lang}/classes`} className="transition-colors hover:text-ink" title="Classes">
                🎒
              </Link>
