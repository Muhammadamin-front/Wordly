...
export function VocoraForestHero({
  ...
  return (
    <section className="relative mx-auto min-h-[calc(100svh-5rem)] max-w-370 overflow-hidden rounded-[22px] border-2 border-brand-950 bg-brand-950 shadow-[10px_12px_0_rgba(84,37,15,0.55)] sm:min-h-180">
      <Image
        aria-hidden
      ...
      />
      <div aria-hidden className="absolute inset-0 bg-brand-950/68 sm:bg-brand-950/52" />
      ...
      <div className="relative z-10 flex min-h-[calc(100svh-5rem)] flex-col px-5 py-8 sm:min-h-180 sm:px-10 sm:py-12 lg:px-14 lg:py-14">
        <Reveal>
          <p className="print-label inline-flex items-center gap-2 border-sand-100/45 bg-brand-900/72 text-sand-100 sm:rounded-none sm:border-x-0 sm:border-t-0 sm:bg-transparent sm:px-0 sm:pb-2">
        ...
        <div className="mt-10 max-w-190 sm:mt-9">
          <Reveal delay={0.06}>
            ...
            <h1 className="editorial-title mt-5 max-w-160 text-[54px] text-brand-50 min-[390px]:text-[62px] sm:mt-3 sm:max-w-185 sm:text-7xl lg:text-[92px]">
          ...
          <Reveal delay={0.18}>
            <div className="mt-8 grid grid-cols-2 gap-3 sm:mt-7 sm:flex">
              <HeroCta
                ...
                className="h-auto min-h-16 w-full justify-center border-2 border-sand-100/28 bg-brand-500 px-4 text-center text-brand-50 shadow-[5px_6px_0_rgba(0,0,0,0.36)] hover:-translate-y-0.5 hover:bg-brand-600 sm:h-auto sm:min-h-0 sm:w-auto sm:px-5"
              ...
              <Link href={`/${lang}/preview/a1`}>
                <Button
                  size="lg"
                  variant="secondary"
                  className="h-auto min-h-16 w-full whitespace-normal border-sand-100/28 bg-brand-900/80 px-4 text-center leading-5 text-white shadow-none hover:border-sand-100/55 hover:bg-brand-800 hover:text-white sm:h-auto sm:min-h-0 sm:w-auto sm:whitespace-nowrap sm:px-5"
                >
                  {copy.exploreLevels}
        ...
        <Reveal delay={0.24}>
          <div className="mt-auto grid max-w-[430px] grid-cols-2 rounded-2xl border border-white/14 bg-brand-900/80 p-4 shadow-[0_18px_40px_rgba(0,0,0,0.2)] backdrop-blur-sm sm:rounded-none sm:border-x-0 sm:border-t-0 sm:bg-transparent sm:p-0 sm:shadow-none sm:backdrop-blur-none sm:pt-10">
            {metrics.map(({ icon: Icon, value, label }) => (
              <div key={label} className="border-white/22 px-3 first:border-r sm:border-t sm:px-0 sm:pt-4 sm:first:border-r-0 sm:[&:not(:first-child)]:pl-6">
                <Icon className="mb-2 size-5 text-brand-200 sm:size-4" strokeWidth={1.5} aria-hidden />
      ...
      <div aria-hidden className="absolute right-7 top-1/2 hidden -translate-y-1/2 lg:flex lg:flex-col lg:items-center lg:gap-3">
        ...
        <span className="size-2 rotate-45 border border-white bg-brand-300" />
