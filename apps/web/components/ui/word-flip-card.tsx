...
export function WordFlipCard({
  ...
  // backface-visibility is supposed to hide whichever face is rotated away
  // from the viewer, but WebKit has long-standing bugs compositing it inside
  // nested preserve-3d contexts (this card has two: the hover-tilt article
  // and the flip itself) — the two faces end up simultaneously visible,
  // overlapping and unreadable. backface-visibility is kept as a best-effort
  // (correct where the browser gets it right, and it's what makes the
