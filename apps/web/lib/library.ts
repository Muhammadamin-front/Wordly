...
export const SHELVES: ShelfMeta[] = [
  ...
  { slug: "b1", key: "B1", level: "B1", gradient: "from-blue-500/20 to-blue-500/5", bar: "bg-blue-500", text: "text-blue-600 dark:text-blue-400", ring: "ring-blue-500/30", overlay: "from-blue-950 via-blue-950/70", accent: "text-blue-300", art: "from-blue-500 via-blue-700 to-blue-950", cover: "/images/levels/b1-communicator.png" },
  { slug: "b2", key: "B2", level: "B2", gradient: "from-indigo-500/20 to-indigo-500/5", bar: "bg-indigo-500", text: "text-indigo-600 dark:text-indigo-400", ring: "ring-indigo-500/30", overlay: "from-indigo-950 via-indigo-950/70", accent: "text-indigo-300", art: "from-indigo-500 via-indigo-700 to-indigo-950", cover: "/images/levels/b2-guardian.png" },
  { slug: "c1", key: "C1", level: "C1", gradient: "from-purple-500/20 to-purple-500/5", bar: "bg-purple-500", text: "text-purple-600 dark:text-purple-400", ring: "ring-purple-500/30", overlay: "from-purple-950 via-purple-950/70", accent: "text-purple-300", art: "from-purple-500 via-purple-700 to-purple-950", cover: "/images/levels/c1-scholar.png" },
  { slug: "c2", key: "C2", level: "C2", gradient: "from-violet-500/20 to-violet-500/5", bar: "bg-violet-500", text: "text-violet-600 dark:text-violet-400", ring: "ring-violet-500/30", overlay: "from-violet-950 via-violet-950/70", accent: "text-violet-300", art: "from-violet-500 via-violet-700 to-violet-950", cover: "/images/levels/c2-master.png" },
  { slug: "ielts", key: "ielts", category: "ielts", gradient: "from-orange-500/20 to-orange-500/5", bar: "bg-orange-500", text: "text-orange-600 dark:text-orange-400", ring: "ring-orange-500/30", overlay: "from-orange-950 via-orange-950/70", accent: "text-orange-300", art: "from-orange-500 via-orange-700 to-orange-950", cover: "/images/levels/ielts-champion.png" },
  ...
  { slug: "expressions", key: "expressions", href: "expressions", gradient: "from-rose-500/20 to-rose-500/5", bar: "bg-rose-500", text: "text-rose-600 dark:text-rose-400", ring: "ring-rose-500/30", overlay: "from-rose-950 via-rose-950/70", accent: "text-rose-300", art: "from-rose-500 via-rose-700 to-rose-950", cover: "/images/levels/b2-guardian.png" },
  { slug: "business", key: "business", gradient: "from-cyan-500/20 to-cyan-500/5", bar: "bg-cyan-500", text: "text-cyan-600 dark:text-cyan-400", ring: "ring-cyan-500/30", overlay: "from-cyan-950 via-cyan-950/70", accent: "text-cyan-300", art: "from-cyan-500 via-cyan-700 to-cyan-950", cover: "/images/levels/c1-scholar.png", soon: true },
];
