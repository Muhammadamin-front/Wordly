...
export const SHELVES: ShelfMeta[] = [
  ...
  { slug: "toefl", key: "toefl", category: "toefl", gradient: "from-brand-600/20 to-brand-600/5", bar: "bg-brand-600", text: "text-brand-600 dark:text-brand-300", ring: "ring-brand-600/30", accent: "text-brand-200" },
  { slug: "sat", key: "sat", category: "sat", gradient: "from-accent-500/20 to-accent-500/5", bar: "bg-accent-600", text: "text-accent-600 dark:text-accent-300", ring: "ring-accent-500/30", accent: "text-accent-300" },
  ...
  { slug: "business", key: "business", category: "business", gradient: "from-accent-500/20 to-accent-500/5", bar: "bg-accent-500", text: "text-accent-600 dark:text-accent-300", ring: "ring-accent-500/30", accent: "text-accent-300" },
];
