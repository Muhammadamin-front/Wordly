...
export const SHELVES: ShelfMeta[] = [
  ...
  { slug: "b1", key: "B1", level: "B1", gradient: "from-cyan-600/18 to-cyan-600/4", bar: "bg-cyan-700", text: "text-cyan-800 dark:text-cyan-300", ring: "ring-cyan-600/30", overlay: "from-cyan-950 via-cyan-950/70", accent: "text-cyan-300", art: "from-cyan-600 via-cyan-800 to-cyan-950", cover: "/images/levels/b1-communicator.png" },
