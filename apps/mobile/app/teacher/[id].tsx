...
const styles = StyleSheet.create({
  ...
  students: { gap: 8 }, student: { flexDirection: "row", alignItems: "center", gap: 11, padding: 12 }, avatar: { width: 38, height: 38, borderRadius: 19, alignItems: "center", justifyContent: "center", backgroundColor: colors.brand600 }, avatarText: { fontFamily: fonts.uiBold, fontSize: 16, color: colors.raised }, studentCopy: { flex: 1, minWidth: 0, gap: 2 }, studentName: { fontFamily: fonts.uiBold, fontSize: 14, color: colors.ink }, studentMeta: { fontFamily: fonts.uiMedium, fontSize: 11, color: colors.muted }, reviewTotal: { fontFamily: fonts.uiBold, fontSize: 16, color: colors.ink }, reviewLabel: { fontFamily: fonts.uiMedium, fontSize: 10, color: colors.muted },
