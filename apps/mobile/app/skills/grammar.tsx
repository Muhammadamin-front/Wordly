...
const styles = StyleSheet.create({
  ...
  level: { minWidth: 50, minHeight: 44, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: colors.line, borderRadius: 10, paddingHorizontal: 11, backgroundColor: colors.cream },
  ...
  levelTextActive: { color: colors.raised },
  ...
  number: { width: 25, height: 25, overflow: "hidden", borderRadius: 13, textAlign: "center", fontFamily: fonts.uiBold, fontSize: 11, lineHeight: 25, color: colors.raised, backgroundColor: colors.brand600 },
  prompt: { flex: 1, fontFamily: fonts.uiBold, fontSize: 15, lineHeight: 23, color: colors.ink },
  options: { gap: 8 },
  option: { minHeight: 46, justifyContent: "center", borderWidth: 1, borderColor: colors.line, borderRadius: 10, paddingHorizontal: 12, backgroundColor: colors.raised },
