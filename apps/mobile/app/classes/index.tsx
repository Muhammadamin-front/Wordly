...
const labels = {
  uz: { title: "Mening sinflarim", subtitle: "O‘qituvchingiz bergan mashqlarni shu yerda kuzating.", join: "Sinfga qo‘shilish", code: "Join code", joinButton: "Qo‘shilish", invalid: "Join code topilmadi. Kodni qayta tekshiring.", assignments: "Topshiriqlar", noClasses: "Hali sinfga qo‘shilmagansiz. O‘qituvchidan join code so‘rang.", due: "Muddat", of: "dan", reviews: "takrorlash", done: "Bajarildi", overdue: "Muddati o‘tgan", load: "Sinflar yuklanmoqda...", loadError: "Sinflarni yuklab bo‘lmadi.", retry: "Qayta urinish", joinSuccess: "Sinfga qo‘shildingiz." },
  ru: { title: "Мои классы", subtitle: "Следите за заданиями от преподавателя в одном месте.", join: "Присоединиться к классу", code: "Код класса", joinButton: "Присоединиться", invalid: "Код класса не найден. Проверьте его ещё раз.", assignments: "Задания", noClasses: "Вы пока не в классе. Попросите у преподавателя код класса.", due: "Срок", of: "из", reviews: "повторений", done: "Готово", overdue: "Срок истёк", load: "Загружаем классы...", loadError: "Не удалось загрузить классы.", retry: "Повторить", joinSuccess: "Вы присоединились к классу." },
  en: { title: "My classes", subtitle: "Keep teacher assignments and your progress in one place.", join: "Join a class", code: "Class code", joinButton: "Join", invalid: "We couldn't find that class code. Check it and try again.", assignments: "Assignments", noClasses: "You have not joined a class yet. Ask your teacher for a class code.", due: "Due", of: "of", reviews: "reviews", done: "Done", overdue: "Overdue", load: "Loading classes...", loadError: "We couldn't load your classes.", retry: "Try again", joinSuccess: "You joined the class." },
} as const;
