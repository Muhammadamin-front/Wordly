...
const styles = StyleSheet.create({
  hero: { gap: 13, borderWidth: 1.5, borderColor: colors.brand950, borderRadius: 16, padding: 19, backgroundColor: colors.inkSurface, shadowColor: colors.brown, shadowOpacity: .26, shadowRadius: 10, shadowOffset: { width: 0, height: 5 }, elevation: 4 }, heroIcon: { width: 48, height: 48, alignItems: "center", justifyContent: "center", borderRadius: 13, backgroundColor: colors.brand600 }, progressRow: { flexDirection: "row", alignItems: "center", gap: 14, marginTop: 4 }, progressValue: { fontFamily: fonts.uiBold, fontSize: 23, color: colors.onAccent }, progressLabel: { fontFamily: fonts.uiMedium, fontSize: 10, textTransform: "uppercase", letterSpacing: .6, color: "#EBC99F" }, progressTrack: { flex: 1, height: 8, overflow: "hidden", borderRadius: 4, backgroundColor: "rgba(255,248,234,0.24)" }, progressFill: { height: "100%", borderRadius: 4, backgroundColor: colors.gold500 },
  ...
  weakBox: { gap: 8, borderWidth: 1, borderColor: "rgba(185,78,40,.25)", borderRadius: 14, padding: 14, backgroundColor: "rgba(185,78,40,.05)" }, weakTitle: { flexDirection: "row", alignItems: "center", gap: 7 }, weakHeading: { fontFamily: fonts.uiBold, fontSize: 16, color: colors.ink }, weakRow: { minHeight: 48, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 10, borderRadius: 10, paddingHorizontal: 11, backgroundColor: colors.raised }, weakName: { flex: 1, fontFamily: fonts.uiBold, fontSize: 13, color: colors.ink }, weakScore: { fontFamily: fonts.uiBold, fontSize: 13, color: colors.rust }, weakEmpty: { fontFamily: fonts.ui, fontSize: 13, lineHeight: 20, color: colors.muted },
  path: { marginTop: 2, fontFamily: fonts.uiBold, fontSize: 12, letterSpacing: .7, textTransform: "uppercase", color: colors.muted }, levels: { flexDirection: "row", flexWrap: "wrap", gap: 8 }, level: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: 5, borderWidth: 1, borderColor: colors.line, borderRadius: 10, paddingHorizontal: 11, backgroundColor: colors.cream }, levelText: { fontFamily: fonts.uiBold, fontSize: 13, color: colors.ink }, levelCount: { fontFamily: fonts.uiMedium, fontSize: 10, color: colors.muted }, levelTextActive: { color: colors.onAccent }, categories: { flexDirection: "row", flexWrap: "wrap", gap: 7 }, category: { minHeight: 48, justifyContent: "center", borderWidth: 1, borderColor: colors.line, borderRadius: 999, paddingHorizontal: 14, backgroundColor: colors.cream }, categoryActive: { borderColor: colors.brand600, backgroundColor: colors.brand600 }, categoryText: { fontFamily: fonts.uiBold, fontSize: 12, color: colors.ink }, categoryTextActive: { color: colors.onAccent },
