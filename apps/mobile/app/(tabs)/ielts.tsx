...
export default function Ielts() {
  ...
  return (
    <Screen appHeader>
      ...
      <Pressable accessibilityRole="button" accessibilityLabel={t.mockCta} onPress={() => router.push("/ielts/mock")} style={({ pressed }) => [styles.mockCard, pressed && styles.pressed]}>
        <Text accessibilityElementsHidden style={styles.mockWatermark}>4</Text>
        <View style={styles.mockTop}><View style={styles.mockIcon}><Ionicons name="trophy-outline" size={24} color={colors.gold300} /></View><View style={styles.mockTime}><Ionicons name="time-outline" size={14} color={colors.gold300} /><Text style={styles.mockTimeText}>{t.mockTime}</Text></View></View>
        <Text style={styles.mockKicker}>{t.mockKicker}</Text><Text style={styles.mockTitle}>{t.mockTitle}</Text><Text style={styles.mockBody}>{t.mockBody}</Text>
        <View style={styles.mockAction}><Text style={styles.mockActionText}>{t.mockCta}</Text><Ionicons name="arrow-forward" size={17} color={colors.brand950} /></View>
      </Pressable>
