...
const labels = {
  uz: { close: "Yopish", listen: "Talaffuzni eshitish", meaning: "Ma'no", definition: "Ta'rif", usage: "Qo'llanishi", examples: "Misollar", family: "So'z oilasi", mistake: "Ko'p uchraydigan xato", loading: "So'z ma'lumotlari yuklanmoqda", loadError: "So'z ma'lumotlarini yuklab bo'lmadi.", addError: "So'zni kartalarga qo'shib bo'lmadi. Qayta urinib ko'ring.", add: "Kartalarga qo'shish", added: "Kartalarga qo'shildi" },
  ru: { close: "Закрыть", listen: "Прослушать произношение", meaning: "Значение", definition: "Определение", usage: "Употребление", examples: "Примеры", family: "Семья слов", mistake: "Распространённая ошибка", loading: "Загружаем сведения о слове", loadError: "Не удалось загрузить сведения о слове.", addError: "Не удалось добавить слово в карточки. Попробуйте снова.", add: "Добавить в карточки", added: "Добавлено в карточки" },
  en: { close: "Close", listen: "Hear pronunciation", meaning: "Meaning", definition: "Definition", usage: "Usage", examples: "Examples", family: "Word family", mistake: "Common mistake", loading: "Loading word details", loadError: "We couldn't load word details.", addError: "We couldn't add this word to your cards. Try again.", add: "Add to cards", added: "Added to cards" },
} as const;
      ...
      <SafeAreaView edges={["top", "bottom"]} style={styles.safe}>
        <View accessibilityViewIsModal style={styles.sheet}>
          ...
          <ScrollView contentContainerStyle={styles.body} showsVerticalScrollIndicator={false}>
            ...
            {detail.isError ? <Text accessibilityRole="alert" style={styles.error}>{t.loadError}</Text> : null}
