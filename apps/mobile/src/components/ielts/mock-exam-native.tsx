...
const styles = StyleSheet.create({
  ...
  heroTitle: { maxWidth: 340, fontFamily: fonts.display, fontSize: 38, lineHeight: 42, letterSpacing: .6, textTransform: "uppercase", color: colors.raised },
  ...
  reportHero: { alignItems: "center", gap: 8, padding: 23, borderRadius: 18, backgroundColor: colors.brand950 }, trophy: { width: 66, height: 66, alignItems: "center", justifyContent: "center", borderRadius: 33, backgroundColor: "rgba(70,120,120,.35)" }, reportTitle: { marginTop: 5, fontFamily: fonts.display, fontSize: 28, textAlign: "center", color: colors.raised }, reportLabel: { fontFamily: fonts.uiBold, fontSize: 10, letterSpacing: .7, textTransform: "uppercase", color: colors.gold300 }, reportBand: { fontFamily: fonts.display, fontSize: 76, lineHeight: 80, color: colors.gold300 }, reportBody: { fontFamily: fonts.ui, fontSize: 13, lineHeight: 20, textAlign: "center", color: colors.brand200 }, reportGrid: { gap: 10 }, reportLeg: { flexDirection: "row", alignItems: "center", gap: 11 }, reportLegTitle: { fontFamily: fonts.uiBold, fontSize: 14, color: colors.ink }, reportLegBand: { fontFamily: fonts.display, fontSize: 31, color: colors.teal },
});
