...
const closeCopy = { uz: "Yopish", ru: "Закрыть", en: "Close" } as const;
    ...
    return (
      <View style={styles.page}>
        ...
        <View style={styles.resultHero}>
          <View style={styles.resultSeal}><Ionicons name="checkmark" size={25} color={colors.onAccent} /></View>
          ...
          <View style={styles.resultActions}>
            <Pressable accessibilityRole="button" onPress={() => void launch(mode, true)} style={({ pressed }) => [styles.primaryButton, pressed && styles.pressed]}><Ionicons name="refresh" size={17} color={colors.onAccent} /><Text style={styles.primaryButtonText}>{t.tryAgain}</Text></Pressable>
...
function TestCard({ test, locale, history, onOpen }: { test: ReadingPracticeTest; locale: Locale; history?: ReadingHistory; onOpen: () => void }) {
  ...
  return (
    <View style={styles.testCard}>
      ...
      <Pressable accessibilityRole="button" accessibilityLabel={`${t.open}: ${test.title}`} onPress={onOpen} style={({ pressed }) => [styles.primaryButton, pressed && styles.pressed]}><Text style={styles.primaryButtonText}>{t.open}</Text><Ionicons name="arrow-forward" size={16} color={colors.onAccent} /></Pressable>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  page: { gap: 18 },
  back: { alignSelf: "flex-start", minHeight: 48, flexDirection: "row", alignItems: "center", gap: 7, paddingRight: 12 },
  ...
  segment: { flex: 1, minHeight: 48, alignItems: "center", justifyContent: "center", borderRadius: 20 },
  segmentActive: { backgroundColor: colors.brand600 },
  segmentText: { fontFamily: fonts.uiMedium, fontSize: 13, color: colors.muted },
  segmentTextActive: { fontFamily: fonts.uiBold, color: colors.onAccent },
  ...
  trackStamp: { alignSelf: "flex-start", paddingHorizontal: 9, paddingVertical: 6, borderRadius: 7, backgroundColor: "rgba(36,19,12,0.80)", fontFamily: fonts.uiBold, fontSize: 9, letterSpacing: 0.45, textTransform: "uppercase", color: colors.onAccent },
  ...
  primaryButtonText: { flexShrink: 1, fontFamily: fonts.uiBold, fontSize: 12.5, textAlign: "center", color: colors.onAccent },
  ...
  colorButton: { width: 48, height: 48, borderWidth: 1, borderColor: colors.line, borderRadius: 7 },
  ...
  paragraphLabel: { width: 27, height: 27, textAlign: "center", textAlignVertical: "center", borderRadius: 6, backgroundColor: colors.brand600, fontFamily: fonts.uiBold, fontSize: 11, color: colors.onAccent },
  ...
  options: { gap: 8 },
  option: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: 10, paddingHorizontal: 12, paddingVertical: 9, borderWidth: 1, borderColor: colors.line, borderRadius: 9, backgroundColor: colors.raised },
  ...
  popoverBackdrop: { flex: 1, alignItems: "center", justifyContent: "center", padding: 20 },
  popoverScrim: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(36,19,12,0.45)" },
  ...
  popoverClose: { width: 48, height: 48, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: colors.line, borderRadius: 9, backgroundColor: colors.cream },
  ...
  popoverPrimary: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: 7, paddingHorizontal: 12, borderWidth: 1, borderColor: colors.brand950, borderRadius: 9, backgroundColor: colors.rust },
  popoverPrimaryText: { fontFamily: fonts.uiBold, fontSize: 10.5, color: colors.onAccent },
  popoverSecondary: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: 7, paddingHorizontal: 12, borderWidth: 1, borderColor: colors.line, borderRadius: 9, backgroundColor: colors.cream },
  ...
  drawerTab: { flex: 1, minHeight: 48, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 5, paddingHorizontal: 7, borderRadius: 9 },
  ...
  drawerTabTextActive: { color: colors.onAccent },
  drawerClose: { width: 48, height: 48, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: colors.line, borderRadius: 9, backgroundColor: colors.cream },
  ...
  deleteButton: { alignSelf: "flex-start", minHeight: 48, flexDirection: "row", alignItems: "center", gap: 5 },
  ...
  favouriteButton: { width: 48, height: 48, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: colors.line, borderRadius: 9, backgroundColor: colors.raised },
  ...
  learnedButton: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 10, borderRadius: 8, backgroundColor: "rgba(185,78,40,0.08)" },
  ...
  trashButton: { width: 48, height: 48, alignItems: "center", justifyContent: "center" },
  ...
  sourceToggle: { alignSelf: "flex-start", minHeight: 48, flexDirection: "row", alignItems: "center", gap: 7, marginTop: 4, paddingHorizontal: 11, borderWidth: 1, borderColor: colors.line, borderRadius: 9, backgroundColor: colors.cream },
