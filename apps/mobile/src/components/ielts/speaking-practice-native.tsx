...
function QuestionWheel({topics,locale,onOpen}:{topics:SpeakingTopic[];locale:Locale;onOpen:(topic:SpeakingTopic)=>void}){
  const t = copy[locale];
  const { enabled: soundOn, setEnabled: setSoundOn } = useSoundEffects();
