...
const styles = StyleSheet.create({
  ...
  taskTabTitleActive: { color: colors.onAccent },
  ...
  smallButton: { minHeight: 48, justifyContent: "center", paddingHorizontal: 11, borderWidth: 1, borderColor: colors.line, borderRadius: 9, backgroundColor: colors.raised },
  ...
  processNumberText: { fontFamily: fonts.uiBold, fontSize: 10, color: colors.onAccent },
